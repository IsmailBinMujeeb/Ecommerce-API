...
import { fetchOrderValidator, FetchAllOrdersValidator, placeOrderValidator } from "../../validators/order.validator.js";
...
router.get("/", authenticationMiddleware, FetchAllOrdersValidator(), validatorMiddleware, cacheMiddleware(req => `orders:${req.user.id}:${req.query.cursor || 1}:${req.query.limit || 10}`), AsyncHandler(FetchAllOrdersController));
