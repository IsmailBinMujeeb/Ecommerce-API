...
router.get("/:id", FetchAllReviewsForProductValidator(), validatorMiddleware, cacheMiddleware(req => `reviews:${req.params.id}`), AsyncHandler(FetchAllReviewsForAProductController));
