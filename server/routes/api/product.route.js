...
import { CreateProductValidator, DeleteProductValidator, FetchProductValidator, UpdateProductValidator } from "../../validators/product.validator.js";
...
router.get("/:id", FetchProductValidator(), validatorMiddleware, AsyncHandler(FetchProductController));
