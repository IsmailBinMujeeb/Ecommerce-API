...
export const CreateProductValidator = () => [
    ...
    body("product_description")
        .optional()
        .isString()
        .withMessage("product_description must be a string"),

    body("product_offer")
        .notEmpty()
        .withMessage("product_offer is required")
        .bail()
        .isFloat({ min: 0 })
        .withMessage("product_offer must be a non-negative number")
        .bail()
        .toFloat(),
    ...
    body("product_price")
        ...
        .bail()
        .isFloat({ gt: 0 })
        .withMessage("product_price must be a positive number")
        .bail()
        .toFloat(),

    body("product_stock")
        .notEmpty()
        .withMessage("product_stock is required")
        .bail()
        .isInt({ min: 0 })
        .withMessage("product_stock must be a non-negative integer")
        .bail()
        .toInt(),
