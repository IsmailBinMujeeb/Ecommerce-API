...
export const UserRegisterController = async (req, res) => {
    ...
    return res
        .status(201)
        .json(
            ApiResponse.UserResponse(201, "user created successfully", newUser),
        );
};
...
export const UserLoginController = async (req, res) => {
    ...
    return res
        .status(200)
        .json(
            ApiResponse.UserResponse(200, "user logged in successfully", user),
        );
};
...
export const UserLogoutController = async (req, res) => {
    ...
    return res
        .status(200)
        .json(ApiResponse.UserResponse(200, "user logged out successfully"));
};
...
export const refreshAccessToken = async (req, res) => {
    ...
    if (user.refresh_token != incomming_refresh_token)
    ...
    return res
        .status(200)
        .json(
            new ApiResponse(200, "tokens regenerated successfully", {
...
export const saveUserAddressController = async (req, res) => {
    ...
    return res
        .status(201)
        .json(new ApiResponse(201, "address created", newAddress));
};
...
export const getUserAddressController = async (req, res) => {
    ...
    return res
        .status(200)
        .json(new ApiResponse(200, "Address fetched successfuly", address));
};
