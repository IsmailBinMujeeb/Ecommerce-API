...
export const FetchAllProductsController = async (req, res) => {
    ...
    return res
        .status(200)
        .json(
            new ApiResponse(200, "fetched all producrs successfully", {
                products,
                nextCursor,
            }),
        );
...
export const FetchProductController = async (req, res) => {
    ...
    return res
        .status(200)
        .json(new ApiResponse(200, "fetched product successfully", product));
};
...
export const UpdateProductController = async (req, res) => {
    const { id } = req.params;
    const { product_name, product_description, product_offer, product_price } =
        req.body;
    ...
    return res
        .status(200)
        .json(
            new ApiResponse(200, "product update successfully", updatedProduct),
        );
};
